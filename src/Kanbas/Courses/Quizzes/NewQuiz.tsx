export default function NewQuize() {
  return (
    <div className="d-flex flex-column" id="wd-home">
      <div className="flex-grow-1 d-flex align-content-center justify-content-between py-3 border-bottom mb-4">
        <input type="email" className="form-control w-auto" id="exampleFormControlInput1" placeholder="Search for Quiz" />
      ...
      <ul className="wd-lessons list-group rounded-0">
        <li className="d-flex align-items-center justify-content-between wd-lesson list-group-item p-3 ps-1">
          <div className="d-flex align-items-center">
            ...
            <div className="d-flex flex-column">
              <div className="fs-6 fw-bold">History of Rocketry</div>
